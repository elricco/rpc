...
$(function () {
  ...
  function init_calculator() {
    getBasics(); // set range slider for black and white pages
  ...
  if ($('#billing_form').length) {
    ...
    $('[name*="delivery_address_same_as_billing_address"]').on('click', function () {
      if ($(this).prop('checked')) {
        ...
        var id = $('[name="salutation"]:checked').attr('id');
        var split_id = id.split('-');
        var last_string = split_id.slice(-1);
...
//# sourceMappingURL=print_configurator.js.map
